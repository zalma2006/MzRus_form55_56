...
fly_yes_llc_group = ('воронежск', 'иркутск', 'курган', 'москов', 'нижегород', 'свердловск', 'томск', 'ленинградск',
                     'забайкал', 'камчат', 'приморс', 'xабаров', 'бурят', 'коми', 'якутия', 'ханты', 'хмао', 'дагест',
                     'москва')
...
base_path = r'/media/maks/ntfs/Ирина/диссер статистика/Ф.55,56 (2015-2020гг)/Ф.55,56 (2015-2020гг)/2019 г/ФОРМА 55/' \
            r'для программы'
papki = [x for x in os.listdir(base_path) if x.endswith(('.xls', '.xlsx'))]
