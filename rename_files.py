...
def rename_files(base_path):
    ...
    for name_file in papki:
        for rename_file, val in rename_region.items():
            if rename_file in name_file.lower():
                try:
...
rename_region = {'алтайский': '22_Алтайский_край', 'амурск': '28_Амурская_область',
                 'архангельск': '29_Архангельская_область', 'астраханск': '30_Астраханская_область',
                 ...
                 'дагестан': '05_Республика_Дагестан', 'ингуш': '06_Республика_Ингушетия',
                 ...
                 'ульяновск': '73_Ульяновская_область', 'xабаров': '27_Хабаровский_край',
...
fly_yes_llc_group = ('воронежск', 'иркутск', 'курган', 'москов', 'нижегород', 'свердловск', 'томск', 'ленинградск',
                     'забайкал', 'камчат', 'приморс', 'xабаров', 'бурят', 'коми', 'якутия', 'ханты', 'хмао', 'дагестан',
                     'москва')
fly_no_llc_group = ('мурман', 'новгородск', 'новосиб', 'омск', 'оренбург', 'псков', 'саратов', 'тамбов', 'тюменск',
                    ...
                    'амурск', 'архангельск', 'киров', 'костром', 'сахалин')
no_fly_group = ('карачаев', 'ингуш', 'чуваш', 'чечен', 'мордов', 'удмурт', 'кемеров', 'орлов', 'ростов', 'рязан',
                'челябинск', 'ярослав', 'рязан', 'калужск', 'пензен', 'астраханск', 'липецк', 'магадан', 'кабардин',
                'самар', 'ставрополь', 'тверская', 'тульск', 'ульяновск', 'чукот')

path_actual(forma=forma)
path_actual(forma=forma + 1)
##
base_path = r'/media/maks/ntfs/Ирина/диссер статистика/Ф.55,56 (2015-2020гг)/Ф.55,56 (2015-2020гг)/2015 г/ФОРМА 55/' \
            r'для программы'
papki = [x for x in os.listdir(base_path) if x.endswith(('.xls', '.xlsx'))]
sorted(papki)
